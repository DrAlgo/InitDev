...
\begin{action}
\item {\bf Sa seigneurie Quick sort} Nous allons maintenant nous mesurer à un adversaire de taille: l'algorithme {\em quick sort} implémenté dans la fonction native {\tt sort()} de python. Commencez par aller jeter un oeil sur le travail étrange que fait quick sort dans \href{https://visualgo.net/en/sorting}{Visualgo}. 
