...
\begin{center}
    \fcolorbox{gray!50}{gray!50}{\Large \tt Notice d'utilisation de la bibliothèque graphique {\tt librapythk}}
\end{center}
...
\section{Ouverture/fermeture de sessions graphique, objet graphique}
