...
{\tt tkiteasy} est une bibliothèque/librairie "{\it maison}" qui va vous permettre de gérer des graphismes sans nécessiter de vous plonger dans le module {\tt tkinter}. Elle est en fait une interface simple entre vous et ce module {\tt tkinter} qui impose un certain apprentissage.
...
\subsubsection*{\fbox{\tt deplacer(obj, x, y)}}
...
\subsubsection*{\fbox{\tt recupererClic(obj)}}
